...
name: normalize
description: >
  Normalize design tokens, spacing, and layout to match the Doculet design system.
  Use when a component uses raw Tailwind colours (text-blue-500), hardcoded spacing,
  non-standard border-radius, or after integrating a third-party component that
  doesn't match existing patterns. Trigger phrases: "clean up the styling",
  "make it match the design system", "fix the tokens", "align spacing",
  "this looks inconsistent".
user-invokable: true
args:
  - name: feature
    description: The page, route, or component to normalize (optional)
    required: false
---
