...
export const universityCopy = {
  ...
  pipeline: {
    ...
    kanban: {
      ...
      dragHint: 'Drag to update status',
      enrolledNote: 'Marking enrolled is for internal record-keeping only. Students are not notified.',
      autoAdvanceNote: 'Auto-advances based on verification status',
    },
    filters: {
      status: "Status",
      program: "Program",
  ...
  programs: {
    ...
    programForm: {
      lineItems: {
        ...
        visaAdminFees: 'Visa & admin fees',
        other: 'Other',
      },
      totalLabel: 'Total proof target',
      durationLabel: 'Duration (years)',
      deadlineLabel: 'Application deadline (optional)',
      costPreview: {
        heading: 'Cost preview',
        tuitionLabel: 'Tuition',
        targetLabel: 'Proof target',
      },
    },
    table: {
      name: 'Program name',
