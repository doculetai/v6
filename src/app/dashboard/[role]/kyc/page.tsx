...
export const metadata: Metadata = {
  title: 'KYC Verification — Doculet',
};
...
export default async function KycPage({ params }: PageProps) {
  ...
  return (
    <section className="space-y-8">
      <h1 className="sr-only">KYC Verification</h1>
      ...
      <div className="flex flex-col items-center gap-4 rounded-xl border border-border bg-card py-20 text-center">
        ...
        <p className="max-w-xs text-xs text-muted-foreground">
          Full functionality for <strong>KYC Verification</strong> is coming soon. Your navigation and layout are fully wired.
        </p>
      </div>
    </section>
  );
