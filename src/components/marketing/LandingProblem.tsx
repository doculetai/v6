    ...
    <section className="border-b border-border bg-background py-16 md:py-20">
      <div className="mx-auto max-w-7xl px-6 md:px-10">
        <LandingReveal>
          ...
          <h2
            className="max-w-2xl text-section-h2 font-serif font-semibold leading-tight tracking-tight text-primary"
          >
          ...
          {copy.problem.cards.map((card, i) => (
            <LandingReveal key={card.title} delay={i * 100}>
              <div className="rounded-2xl border border-border bg-card p-6 shadow-sm">
                <p className="font-mono text-2xl font-bold text-primary">{card.stat}</p>
