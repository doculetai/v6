    ...
    <section className="border-b border-border bg-[#F8FAFC] py-16 md:py-20">
      <div className="mx-auto max-w-7xl px-6 md:px-10">
        <LandingReveal>
          ...
          <h2
            className="max-w-2xl font-serif font-semibold leading-tight tracking-tight text-[#2B39A3]"
            ...
            return (
              <LandingReveal key={card.title} delay={i * 100}>
                <div className="relative overflow-hidden rounded-2xl border border-border bg-white p-6 shadow-sm">
                  <p
                    className="absolute bottom-4 right-5 font-mono font-bold leading-none text-muted-foreground/10"
