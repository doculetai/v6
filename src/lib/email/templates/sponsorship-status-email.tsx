...
type SponsorshipStatusEmailProps = {
  copy:
    | (typeof emailCopy)['sponsorshipAccepted']
    | (typeof emailCopy)['sponsorshipDeclined']
    | (typeof emailCopy)['sponsorshipWithdrawn'];
  dashboardUrl: string;
};

export function SponsorshipStatusEmail({ copy, dashboardUrl }: SponsorshipStatusEmailProps) {
  return (
