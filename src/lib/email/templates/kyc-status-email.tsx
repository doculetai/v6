...
type KycStatusEmailProps = {
  status: KycStatus;
  verificationUrl: string;
  failureReason?: string | null;
};

export function KycStatusEmail({ status, verificationUrl, failureReason }: KycStatusEmailProps) {
    ...
    <div style={wrapperStyle}>
      <div style={cardStyle}>
        ...
        {status === 'failed' && failureReason ? (
          <div style={reasonStyle}>{failureReason}</div>
        ) : null}
        <a href={verificationUrl} style={ctaStyle}>
          {copy.ctaLabel}
        </a>
